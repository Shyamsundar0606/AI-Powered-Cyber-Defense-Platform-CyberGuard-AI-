...
import { Activity, ArrowLeft, BrainCircuit, FileCode2, FileText, Loader2, LogOut, Radar, Search, ShieldCheck, Target } from "lucide-react";
      ...
      <div className="grid min-h-screen lg:grid-cols-[280px_1fr]">
        ...
        <section className="px-6 py-6 lg:px-8">
          <header className="mb-6 flex flex-col gap-4 border-b border-slate-200 pb-6 xl:flex-row xl:items-center xl:justify-between">
            <div>
              <h1 className="text-3xl font-semibold text-slate-950">MITRE ATT&CK Knowledge Base</h1>
              <p className="mt-2 text-sm text-slate-500">Browse MITRE ATT&CK techniques, tactics, detections, and mitigations.</p>
            </div>
